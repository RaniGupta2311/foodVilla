...
const About = () => {
  ...
  return (
    <div className="p-4 absolute top-24 w-[100%] min-h-[calc(100vh-6rem)] bg-white flex flex-col items-center">
      <button className="mt-[16px] mb-4 bg-green-800 p-3 rounded-lg text-white font-medium text-lg hover:bg-amber-700"
      onClick={()=>{
      ...
      <div className="flex flex-col items-center lg:flex-row gap-5 lg:justify-between pl-2 pr-2 lg:pl-4 lg:pr-4 xl:pl-20 xl:pr-20">
        ...
        <div className="flex justify-center items-center">
          <img src={Burger} alt="burger" className="bg-white max-w-[90%]" />
        </div>
      </div>
