...
const Body=()=>{
    ...
    if(!isOnline){
        return <div className="p-4 absolute top-24 bg-gray-100 w-[100%] min-h-[calc(100vh-6rem)] flex items-center justify-center">
            <h1 className="text-xl">❌ Seems you are offline!
